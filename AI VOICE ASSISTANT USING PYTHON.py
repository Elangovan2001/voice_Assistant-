...
def sendEmail(to, content):
    ...
    server.ehlo()
    server.starttls()
    server.login('satishelango8@gmail.com', 'elango')
...
if __name__ == "__main__":
    ...
    #logic for executing tasks based on query
        ...
        if 'open youtube' in query:
        ...
        elif 'email to elango' in query:
            try:
                speak("what should I send sir?")
                content = takeCommand().lower()
                to = "satishelango8@gmail.com"
                sendEmail(to,content)
                speak('Email has been sent sir')
            ...
            speak("I have been created by Raja.")
            ...
            speak("Thanks to Elango. further It's a secret")

        elif 'is love' in query:
            speak("It is 7th sense that destroy all other senses")

        elif "who are you" in query:
            speak("I am your virtual assistant created by elango")

        elif 'reason for creating you' in query:
            speak("I was created as a Minor project by Mister Elango")
